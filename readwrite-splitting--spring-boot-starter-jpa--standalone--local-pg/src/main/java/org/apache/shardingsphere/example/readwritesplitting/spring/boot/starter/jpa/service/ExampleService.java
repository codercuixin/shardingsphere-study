...
package org.apache.shardingsphere.example.readwritesplitting.spring.boot.starter.jpa.service;

import org.apache.shardingsphere.example.readwritesplitting.spring.boot.starter.jpa.entity.Address;
import org.apache.shardingsphere.example.readwritesplitting.spring.boot.starter.jpa.entity.Order;
import org.apache.shardingsphere.example.readwritesplitting.spring.boot.starter.jpa.entity.OrderItem;
import org.apache.shardingsphere.example.readwritesplitting.spring.boot.starter.jpa.repository.AddressRepository;
import org.apache.shardingsphere.example.readwritesplitting.spring.boot.starter.jpa.repository.OrderItemRepository;
import org.apache.shardingsphere.example.readwritesplitting.spring.boot.starter.jpa.repository.OrderRepository;
...
//            this.cleanEnvironment();
    ...
    private void initEnvironment() throws SQLException {
        ...
        //wait ten seconds make sure create in replica
        try {
